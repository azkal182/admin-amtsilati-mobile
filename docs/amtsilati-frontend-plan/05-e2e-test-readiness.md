...
- Retest tambahan: fixture `E2E_USERS_20260909` tanpa `users.manage` menerima `403` pada list Admin Users; fixture `E2E_STORE_20260909` berhasil dibuat dan diubah (`200`). Fixture tambahan tersebut masih perlu dibersihkan dengan prefix masing-masing.
